...
<body class="center-content">
    ...
    <div class="container">
        ...
        <div class="login-info">
            ...
            <form action='loginPage.php' method='POST'>
                ...
                <p> <a href="registerPage.php">Forgot password?</a> or <a href="registerPage.php">Sign in</a> </p>           
            </form>
        </div>
    </div>
    ...
    <?php
        ...
        if(isset($_POST['Email-User']) && isset($_POST['Password-User'])){
            ...
            if($connectionDatabase){
                ...
                $query = "SELECT `Email`, `Password` FROM `signin-user` WHERE `Email`='$email' AND `Password`='$password'";
                ...
                if($connectionQuery && mysqli_num_rows($connectionQuery) > 0){
                    ...
                    echo '<script>';
                    echo "window.alert('Incorrect email or password!')";
                    echo '</script>';
                }
            }else{
                echo '<script>';
